...
<form action ="https://formsubmit.co/puish9986@gmail.com" method="post">
        ...
        <div class="form-group">
            ...
            <option value=""></option>
                ...
                <option value="ZONGSHEN RS3S">ZONGSHEN RS3S</option>
            </select>
        </div>
        ...
        <input type="number" id="price" name="price" value="550" readonly>
        

        <p>
    <label for="total-cost">Total Cost:</label>
    <input type="text" id="total-cost" name="total-cost" value="$550" readonly>
</p>
