...
<body>
    ...
    <form action ="https://formsubmit.co/puish9986@gmail.com" method="post">
        ...
        <div class="form-group">
            ...
            <option value=""></option>
                <option value="MAHINDRA XUV700 AX7 L">MAHINDRA XUV700 AX7 L</option>
                <option value="TOYOTA FORTUNER 4x4">TOYOTA FORTUNER 4x4</option>
                <option value="JEEP RUBICON 2.0 ">JEEP RUBICON 2.0 </option>
            </select>
        </div>
        ...
        <input type="number" id="price" name="price" value="300" readonly>

        <p>
    <label for="total-cost">Total Cost:</label>
    <input type="text" id="total-cost" name="total-cost" value="$300" readonly>
</p>
