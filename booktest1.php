...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $modelName = htmlspecialchars($_POST['model name']);
    $date = htmlspecialchars($_POST['date']);
    $days = intval($_POST['days']);
    $price = floatval($_POST['price']);
    $totalCost = $days * $price;

    // Process booking logic here (e.g., save to database or send email)
    $message = "Booking successful! Thank you, $name. Your selected model is $modelName, and your total cost is $$totalCost.";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<form action ="https://formsubmit.co/puish9986@gmail.com" method="post">
        ...
        <div class="form-group">
            ...
            <option value=""></option>
                ...
                <option value="BMW X7 M60i">BMW X7 M60i</option>
            </select>
        </div>
        ...
        <input type="number" id="price" name="price" value="800" readonly>

        <p>
    <label for="total-cost">Total Cost:</label>
    <input type="text" id="total-cost" name="total-cost" value="$800" readonly>
</p>
