...
<form action ="https://formsubmit.co/puish9986@gmail.com" method="post">
        ...
        <div class="form-group">
            ...
            <option value=""></option>
                <option value="BMW S1000RR PRO">BMW S1000RR PRO</option>
                <option value="KAWASAKI ZX10R">KAWASAKI ZX10R</option>
                <option value="SUZUKI HAYABUSA GSX">SUZUKI HAYABUSA GSX</option>
            </select>
        </div>
        ...
        <input type="number" id="price" name="price" value="850" readonly>
        

        <p>
    <label for="total-cost">Total Cost:</label>
    <input type="text" id="total-cost" name="total-cost" value="$850" readonly>
</p>
