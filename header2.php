...
<nav class="container">
    <img class="img" src="image\pd.jpeg" width="100px" height="100px"> &nbsp;&nbsp;&nbsp;
    <div class="pd">
   <h1>Premium Deluxe <br>Motorsport</h1>
    </div>
        ...
        <ul>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="demo1.php">Motorsport</a></li>

                </ul>
            
            <li><a href="logout.php" class="sign" ><svg  xmlns="http://www.w3.org/2000/svg"
